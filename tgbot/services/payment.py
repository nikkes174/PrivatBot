...
class PaymentService:
    ...
    def __init__(self, merchant_login: str = MERCHANT_LOGIN, password1: str = PASSWORD1):
        self.merchant_login = merchant_login
        self.password1 = password1
        self.pending_payments: Dict[str, int] = {}

    def _generate_signature(self, out_sum: str, inv_id: str, shp_params: Dict[str, str]) -> str:
    ...
    def generate_payment_url(self, user_id: int, months: int, price: int) -> str:
    ...
    async def start_payment(self, callback_query: types.CallbackQuery, months: int, price: int) -> None:
        """
        ...
        logging.info("💰 Новый платёж: user_id=%s, months=%s, amount=%s", user_id, months, price)

...
def first_start_keyboard():
    ...
    builder.button(text="️‍️‍️‍️‍️‍️‍️‍✅ Подписки", callback_data="to_rate")
    builder.button(
...
def chane_sub():
    builder = InlineKeyboardBuilder()
    builder.button(text="️‍️‍️‍️‍️‍️‍️‍✅ Отменить автопродление", callback_data="to_change")
    builder.adjust(1)
    return builder.as_markup()
...
def to_access():
    builder = InlineKeyboardBuilder()
    builder.button(
        text="🔒 Войти в закрытый канал", url="https://t.me/+-E8hgZJHuaQ1NzVi"
    )
    builder.adjust(1, 1)
    return builder.as_markup()
